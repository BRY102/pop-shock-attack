...
function warrantyProofCard(state) {
    if (state.state === 'active') {
        return `<div class="warranty-proof is-active">
            ...
            <p>Covered until ${esc(formatWarrantyDate(state.expires))}. This visit is billed free of charge.</p>
        </div>`;
    }
...
function toolbarSearchHtml({ id, placeholder, value, extra }) {
    return `<div class="toolbar-search">
        ${icon('search')}
        <input type="search" id="${esc(id)}" class="search-bar"
